...
contract PLibraryDelegate is PDelegate, Versioned {
  ...
  function libraryDelegateFwd(string memory _libraryInstanceKey) internal  {
  ...
  function addressFromMsgData(bytes memory _data) private pure returns (address result_) {
